...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Ratings Read</h2>
        <table class="table">
	    ...
	    <tr><td>Priorities Ratings</td><td><?php echo $priorities_ratings; ?></td></tr>
	    <tr><td></td><td><a href="<?php echo site_url('ratings') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>